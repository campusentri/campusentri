        ...
        <div class="text-overlay absolute inset-0 flex items-center flex-col justify-center">
            ...
            <div class="flex items-stretch mt-10 w-full px-3 md:px-10">
                <div class="scroll-btn h-full flex flex-grow-0">
                    <button name="College Button" class="big-circle-btn blue" @click="scrollToNextComponent">
                ...
                <Audio :audioSrc="'/audio/college.mp3'" />
            </div>
        </div>
    </div>
</template>
...
.background-video {
    ...
    &:after {
        background: linear-gradient(-180deg,hsla(4,78%,67%,0),#82ded7);
        content: "";
        display: block;
        height: 100px;
        left: 0;
