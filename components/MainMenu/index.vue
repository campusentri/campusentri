            ...
            <div class="grid grid-cols-3 gap-8 h-full">
                <div class="col-span-2 flex items-center">
                    <ul class="menu-items">
                        ...
                        <li><NuxtLink to="/fee" class="text-[4.5rem] mb-2 text-white"><span>Fees</span></NuxtLink></li>
                ...
                <div class="flex justify-between flex-col">
                    ...
                    <ul class="menu-items">
                        ...
                        <li><NuxtLink class="text-3xl mb-2 text-white" to="/privacyPolicy"><span>Privacy Policy</span></NuxtLink></li>
                    </ul>
                </div>
            </div>
        </nav>
